...
{
    public class ButtonFolderSearch : System.Windows.Forms.Button
    {
        ...
        public ButtonFolderSearch()
        {
            ...
            this.Image = global::FAndradeTI.Util.WinForms.Properties.Resources.folder_search_16;
            this.UseVisualStyleBackColor = true;
            this.Name = "btnFolderSearch";
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                SelectedPath = this.SearchFolder
            })
            {
                DialogResult result = fbd.ShowDialog();

                if (result == DialogResult.OK)
                    this.SearchFolder = fbd.SelectedPath;
            }
        }
